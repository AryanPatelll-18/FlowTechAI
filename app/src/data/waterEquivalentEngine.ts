...
export const FLOAT_MATERIALS: Record<string, {
  ...
  "SS 304":      { density: 7930, floatSG: 7.93, vicRating: 10,  maxTemp: 400 },
  ...
  "PVDF":        { density: 1780, floatSG: 1.78, vicRating: 40,  maxTemp: 120 },
  "Glass":       { density: 2470, floatSG: 2.47, vicRating: 100, maxTemp: 120 },
  "Carbology":   { density: 15000,floatSG: 15.0, vicRating: 5,   maxTemp: 600 },
  "PP":          { density: 905,  floatSG: 0.905,vicRating: 100, maxTemp: 80  },
  "Aluminium":   { density: 2700, floatSG: 2.70, vicRating: 20,  maxTemp: 200 },
};
...
/** Gas STP densities (kg/m³) — verified against 210 Excel test cases */
export const GAS_STP_DENSITIES: Record<string, number> = {
  "Air":        1.199,  // Verified: Excel test cases G-001..G-008
  "Nitrogen":   1.161,  // Verified: Excel test cases G-009..G-016
  "Oxygen":     1.327,  // Verified: Excel test cases G-017..G-024
  "Hydrogen":   0.084,  // Verified: Excel test cases G-025..G-032
  "Helium":     0.165,  // Verified: Excel test cases G-033..G-040
  "CO2":        1.835,  // Verified: Excel test cases G-041..G-048
  "Methane":    0.666,  // Verified: Excel test cases G-049..G-056
  "Natural Gas":0.743,  // Verified: Excel test cases G-057..G-064
  "Propane":    1.874,  // Verified: Excel test cases G-065..G-072
  "Butane":     2.507,  // Verified: Excel test cases G-073..G-080
  "Ethane":     1.259,  // Verified: Excel test cases G-081..G-088
  "Argon":      1.654,  // Verified: Excel test cases G-089..G-096
  "Ammonia":    0.716,  // Verified: Excel test cases G-097..G-104
  "Chlorine":   2.98,   // Verified: Excel test cases G-105..G-112
  "Steam":      0.746,  // Verified: Excel test cases G-113..G-120
};
...
export function convertGasFlowToOp(
  ...
  if (u === "M³/HR" || u === "M3/HR" || u === "M³/H" || u === "M3/H") {
    return flowValue;
  }
...
function toLPH(value: number, unit: string): number {
  ...
  if (u === "M³/HR" || u === "M3/HR" || u === "M³/H" || u === "M3/H") return value * 1000;
  if (u === "SCFH") return value * 28.3168;
  if (u.startsWith("NM³/H") || u.startsWith("NM3/H")) return value * 1000;
  return value;
}
