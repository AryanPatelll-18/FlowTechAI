...
export type ProductFamily =
  ...
  | "acrylic_body_rotameter" | "bypass_rotameter"
  ...
  },
{
    id: "GAD-BPR-001",
    type: "gad_master" as const,
    productFamily: "bypass_rotameter" as const,
    productName: "By-Pass Rotameter",
    title: "Master GAD — By-Pass Glass Tube Rotameter",
    description: "General Assembly Drawing for Flowtech By-Pass Glass Tube Rotameter with orifice plate assembly, borosilicate glass measuring tube, SS float, and by-pass piping arrangement for main pipeline installation.",
    revision: "Rev.1",
    date: "2025-03-12",
    approvedBy: "Quality Manager — Flowtech",
    sections: [
      {
        heading: "1. General Specifications",
        fields: [
          f("Model Series", "FT-BPR-6100 Series", false, "general"),
          f("Measuring Principle", "Variable area — by-pass arrangement with orifice plate", false, "general"),
          f("Orifice Sizes", "15NB to 150NB (main line)", true, "dimension"),
          f("Accuracy", "+-2.0% to +-3.0% of FSD", false, "performance"),
          f("Max Pressure", "16 bar (glass tube) / 40 bar (metal tube)", true, "performance"),
          f("Max Temperature", "120degC (glass), 400degC (metal)", true, "performance"),
          f("Flow Range", "0.1 lph to 150000 lph (water equivalent)", false, "performance"),
        ],
      },
      {
        heading: "2. Materials of Construction",
        fields: [
          f("Orifice Plate", "SS 316 / SS 316L / Hastelloy C", true, "moc"),
          f("Orifice Flanges", "SS 316 / CS IS 2062 / SS 304", true, "moc"),
          f("By-Pass Tube", "SS 316 / SS 304 seamless", true, "moc"),
          f("Measuring Tube", "Borosilicate glass / SS 316 (metal)", true, "moc"),
          f("Float", "SS 316 / SS 316L / PTFE / Titanium", true, "moc"),
          f("End Fittings", "SS 316 / CS / PP / PVC", true, "moc"),
          f("Scale Housing", "Aluminium anodized", true, "moc"),
          f("Gaskets", "PTFE / Viton / EPDM / CAF", true, "moc"),
      ...
      },
      {
        heading: "3. Mechanical Dimensions",
        fields: [
          f("Orifice Plate Thickness", "3 mm to 12 mm (size dependent)", true, "dimension"),
          f("Orifice Bore Diameter", "Calculated per flow rate", true, "dimension"),
          f("By-Pass Tube Size", "15NB / 20NB / 25NB", true, "dimension"),
          f("Overall Height", "200 mm to 1500 mm", true, "dimension"),
          f("Scale Length", "150 mm to 1200 mm", true, "dimension"),
          f("Mounting", "Vertical by-pass branch from main pipeline", false, "mechanical"),
          f("Weight", "2 kg to 25 kg (size dependent)", true, "mechanical"),
        ],
      },
      {
        heading: "4. Electrical / Output Specifications",
        fields: [
          f("Output Signal", "Visual indication only (opt: 4-20mA transmitter + switches)", true, "electrical"),
          f("Power Supply", "N/A (visual) / 24 VDC (transmitter opt)", true, "electrical"),
          f("Display", "Direct reading on engraved aluminium scale", true, "electrical"),
          f("Enclosure Rating", "IP54 (standard) / IP65 (opt)", false, "electrical"),
        ],
      },
      {
        heading: "5. Process Connections & Certifications",
        fields: [
          f("Main Line Connection", "Flanged IS 6392 / ANSI B16.5 / DIN (15NB to 150NB)", true, "mechanical"),
          f("Connection Rating", "PN10/16/25/40", true, "mechanical"),
          f("By-Pass Connections", "Screwed / Flanged / Tri-clamp / Socket weld", true, "mechanical"),
          f("Reference Standards", "VDI/VDE 3513, ISO 11605, IEC 60529", false, "general"),
        ],
      },
    ],
