...
export interface LineItem {
  ...
  // Custom dimensions for datasheet (editable, 5 rows x 2 cols)
  ...
  // Sizing warning message (set by sizing check)
...
function toLineItem(inst: ParsedInstrument, header: SOHeader): LineItem {
  return {
    ...
    customDimensions: inst.customDimensions || [],
    processData: inst.processData,
    sizingWarning: "", // populated by sizing check
    header,
  };
}
